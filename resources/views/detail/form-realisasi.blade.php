<div class="space-y-6">
    ...
    <div class="space-y-3">
        <div class="flex justify-between items-center">
            <label class="block text-sm font-bold text-gray-800 uppercase tracking-wide">Daftar Kendala & Solusi</label>
        </div>

        <div class="struggles-wrapper space-y-4">
            @forelse($final->struggles as $i => $s)
                <div class="struggle-item bg-gray-50 border border-gray-200 p-4 rounded-xl relative">
                    <input type="hidden" name="struggles[{{ $i }}][struggle_id]" value="{{ $s->id }}">
                    
                    <div class="flex items-center justify-between mb-3 border-b border-gray-200 pb-2">
                        <span class="text-sm font-bold text-gray-700">#{{ $i+1 }} Kendala & Solusi</span>
                        {{-- Tombol hapus akan di-handle oleh script di parent --}}
                    </div>
            ...
            @empty
                <div class="struggle-item bg-gray-50 border border-gray-200 p-4 rounded-xl">
                    <input type="hidden" name="struggles[0][struggle_id]" value="">
                    <div class="flex items-center justify-between mb-3 border-b border-gray-200 pb-2">
                        <span class="text-sm font-bold text-gray-700">#1 Kendala & Solusi</span>
                    </div>
